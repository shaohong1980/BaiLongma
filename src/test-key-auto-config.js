...
{
  const infos = detectAllKeyInfos('配置火山语音识别 00000000-0000-0000-0000-000000000000')
...
{
  const infos = detectAllKeyInfos('配置豆包 TTS 00000000-0000-0000-0000-000000000000')
