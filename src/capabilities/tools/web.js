// 联网工具：web_search / fetch_url / browser_read / browser_act。
...
//   web/browser-act.js  —— browser_act（交互式浏览器会话）
...
export { execBrowserAct } from './web/browser-act.js'
export { execDeepResearch } from './web/deep-research.js'
